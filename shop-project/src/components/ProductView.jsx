            ...
            <div className="bg-white p-6 rounded-lg w-full max-w-4xl relative">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="text-left space-y-3 text-[#352118]">
                        ...
                        <select onChange={(e)=>setSelectedSize(e.target.value)} className="border border-[#d5ccc4] text-[#352118] px-4  py-2 rounded w-full">
                        ...
                        <button onClick={()=>{
                            ...
                            } className="bg-[#352118] text-[#d5ccc4] px-4 py-2 w-full mt-2">
